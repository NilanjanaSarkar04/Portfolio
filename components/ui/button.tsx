  ...
  "inline-flex items-center justify-center gap-2.5 whitespace-nowrap font-medium transition-all duration-300 cursor-pointer disabled:pointer-events-none disabled:opacity-50 shrink-0",
  {
    variants: {
      variant: {
        ...
        default: "bg-accent text-white rounded-full hover:bg-accent-hover",
        /** Glass pill — secondary CTA */
        outline: "glass rounded-full text-muted hover:text-foreground",
        /** No background — nav / tertiary links */
        ghost: "text-muted hover:text-foreground hover:bg-surface-hover rounded-full",
        /** Inline text link */
        link: "text-accent hover:text-accent-hover underline-offset-4 hover:underline p-0 h-auto gap-1.5",
      },
      size: {
